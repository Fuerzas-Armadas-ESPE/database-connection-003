...
export class PostsService {
  ...
  async getAllPosts(): Promise<typeof PostSchema[]> {
    return await this.postModel.find().exec();
  }

  async getPost(id: string): Promise<typeof PostSchema | null> {
    try {
  ...
  async createPost(postData: any): Promise<typeof PostSchema> {
    try {
  ...
  async updatePost(id: string, postData: any): Promise<typeof PostSchema | null> {
    try {
